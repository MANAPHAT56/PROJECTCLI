 ...
 navigate(`/detailProducts/${productId}`)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-500 via-sky-400 to-cyan-300 py-12 mt-12">
        <div className="absolute inset-0 bg-white/5"></div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="text-center animate-fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-slate-800 mb-6 bg-gradient-to-br from-black via-gray-900 to-blue-600 bg-clip-text text-transparent">
               โพธิ์ทอง พริ้นติ้ง
            </h1>
