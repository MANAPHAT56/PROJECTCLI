    ...
    <Toaster position="top-center" />
        <Suspense fallback={<div>กำลังโหลดหน้า...</div>}>
          <Routes>
            ...
            <Route path="/blogsHome" element={<Articles  activeSection="home"/>} />
            <Route path="/blogsBenefits" element={<Articles  activeSection="benefits"/>} />
            <Route path="/blogsPurpose" element={<Articles  activeSection="objectives"/>} />
